...
folder = Path('output/report/drawio-erd')
source = folder / 'ERD_43_bang_ro_duong.drawio'
target = folder / 'ERD_43_bang_kieu_du_lieu_ben_phai.drawio'
...
for cell in list(root.findall('mxCell')):
    ...
    type_cell = ET.SubElement(root, 'mxCell', {
        ...
        'style': 'text;html=0;align=right;verticalAlign=middle;whiteSpace=nowrap;overflow=hidden;spacingRight=10;fontFamily=Arial;fontSize=13;strokeColor=none;fillColor=none;',
